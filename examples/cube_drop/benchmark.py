...
KNOWN_RESULTS: list[dict] = [
    ...
    {"backend": "nexus", "mode": "raster", "fps": 33.1, "resolution": "640x480",
     "pipeline": "GPU (WebGPU) physics + render() readback (patched kiss3d + initial-velocity fix, real-time steps)",
     "video": "cube_nexus.mp4", "video_url": "https://files.catbox.moe/q8vl72.mp4", "source": "measured 2026-07-08"},
    {"backend": "nexus_cpu", "mode": "raster", "fps": 26.5, "resolution": "640x480",
     "pipeline": "Rapier CPU physics + render() readback (patched kiss3d + initial-velocity fix, real-time steps)",
    ...
    {"backend": "pybullet", "mode": "rt_shared", "physics_steps_s": 317_000, "fps": 37.7,
     "ms_per_frame": 27, "resolution": "480x360", "spp": 96, "video": "cube_rt_pybullet.mp4", "video_url": "https://files.catbox.moe/9b39vv.mp4"},
    ...
    {"backend": "nexus", "mode": "lerobot_raster", "fps": 4.7, "resolution": "640x480",
     "pipeline": "GPU (WebGPU) multibody, passive (no torque API) + render() readback",
     "video": "lerobot_nexus.mp4",
     "video_url": "https://files.catbox.moe/cvu5rg.mp4", "source": "measured 2026-07-08"},
    {"backend": "nexus", "mode": "lerobot_rt", "fps": 0.7, "resolution": "640x480", "spp": 64,
     "pipeline": "kiss3d wgpu path tracer (per-frame mesh re-bake)",
     "video": "lerobot_nexus_rt.mp4",
     "video_url": "https://files.catbox.moe/hwl51w.mp4", "source": "measured 2026-07-08"},
    {"backend": "nexus", "mode": "rt_native", "fps": 4.2, "ms_per_frame": 236,
     "resolution": "480x368", "spp": 64,
     "pipeline": "kiss3d 0.45 wgpu path tracer (patched kiss3d; tracing-bound)",
     "video": "cube_rt_nexus_native.mp4", "video_url": "https://files.catbox.moe/44cl5o.mp4", "source": "measured 2026-07-08"},
]
